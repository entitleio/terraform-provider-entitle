...
description: |-
  ...
  Required
  forwarder (Attributes) The user who is delegating their access review responsibilities. See forwarder / target below.target (Attributes) The user who will receive and handle the forwarded review tasks. See forwarder / target below.
  Read-Only
