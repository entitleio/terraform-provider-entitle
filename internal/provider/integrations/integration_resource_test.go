...
`, os.Getenv("GITLAB_ACCESS_TOKEN"), os.Getenv("ENTITLE_OWNER_ID"), os.Getenv("ENTITLE_WORKFLOW_ID"), os.Getenv("ENTITLE_USER2_ID"), os.Getenv("ENTITLE_OWNER_ID"), os.Getenv("ENTITLE_USER1_ID"), os.Getenv("ENTITLE_ROLE_ID")),
				Check: resource.ComposeAggregateTestCheckFunc(
					// Verify
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "name", "My Gitlab Integration"),
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "requestable", "true"),
