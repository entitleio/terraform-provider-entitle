...
func TestIntegrationResourceMultipleMaintainers(t *testing.T) {
...
`, os.Getenv("GITLAB_ACCESS_TOKEN"), os.Getenv("ENTITLE_OWNER_ID"), os.Getenv("ENTITLE_WORKFLOW_ID"), os.Getenv("ENTITLE_USER2_ID"), os.Getenv("ENTITLE_DIRECTORY_GROUP_ID"), os.Getenv("ENTITLE_USER1_ID"), os.Getenv("ENTITLE_ROLE_ID")),
				Check: resource.ComposeAggregateTestCheckFunc(
					// Verify
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "name", "My Gitlab Integration"),
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "requestable", "true"),
...
`, os.Getenv("GITLAB_ACCESS_TOKEN"), os.Getenv("ENTITLE_OWNER_ID"), os.Getenv("ENTITLE_WORKFLOW_ID"), os.Getenv("ENTITLE_USER2_ID"), os.Getenv("ENTITLE_DIRECTORY_GROUP_ID"), os.Getenv("ENTITLE_USER1_ID"), os.Getenv("ENTITLE_ROLE_ID")),
				Check: resource.ComposeAggregateTestCheckFunc(
					// Verify
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "name", "My Gitlab Integration"),
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "requestable", "false"),
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "requestable_by_default", "true"),
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "application.name", "gitlab"),
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "allowed_durations.0", "-1"),
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "auto_assign_recommended_maintainers", "false"),
...
`, os.Getenv("GITLAB_ACCESS_TOKEN"), os.Getenv("ENTITLE_OWNER_ID"), os.Getenv("ENTITLE_WORKFLOW_ID"), os.Getenv("ENTITLE_USER2_ID"), os.Getenv("ENTITLE_OWNER_ID"), os.Getenv("ENTITLE_DIRECTORY_GROUP_ID"), os.Getenv("ENTITLE_USER1_ID"), os.Getenv("ENTITLE_ROLE_ID")),
				Check: resource.ComposeAggregateTestCheckFunc(
					// Verify
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "name", "My Gitlab Integration"),
					resource.TestCheckResourceAttr("entitle_integration.my_gitlab", "requestable", "false"),
