...
type IntegrationResourceRoleCreateBodySchema struct {
	...
	// PrerequisitePermissions Prerequisite permissions required for this role
	...
	// Requestable Indicates if the role is requestable
	Requestable bool `json:"requestable"`

	// Resource Unique identifier for the resource
